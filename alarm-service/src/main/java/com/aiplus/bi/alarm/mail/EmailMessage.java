...
public class EmailMessage {
    ...
    private static int MAIL_TIMEOUT = 10000;
    private static int CONNECTION_TIMEOUT = 10000;
    /**
     * 1MB
     */
    private static long TOTAL_ATTACHMENT_MAX_SIZE_IN_BYTE = 1024 * 1024 * 1024;
    private final Logger logger = LoggerFactory.getLogger(EmailMessage.class);
    ...
    public static void setTotalAttachmentMaxSize(final long sizeInBytes) {
        ...
        TOTAL_ATTACHMENT_MAX_SIZE_IN_BYTE = sizeInBytes;
    }
    ...
    public EmailMessage addAttachment(final String attachmentName, final File file)
        ...
        if (this.totalAttachmentSizeSoFar > TOTAL_ATTACHMENT_MAX_SIZE_IN_BYTE) {
            throw new MessageAttachmentExceededMaximumSizeException(
                    "Adding attachment '" + attachmentName
                            ...
                            + TOTAL_ATTACHMENT_MAX_SIZE_IN_BYTE);
        }
